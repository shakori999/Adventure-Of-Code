...
with open("input.txt") as f:
    ...
    paer1 = sum(faul(mass) for mass in masses)
...
requirement is zero or negative. For example:
    ...
    the total fuel required for a module of mass 1969 
    is 654 + 216 + 70 + 21 + 5 = 966.The fuel required by a 
    module of mass 100756 and its fuel is:
    33583 + 11192 + 3728 + 1240 + 411 + 135 + 43 + 12 + 2 = 50346.

"""


def fuel_for_all_faul(mass: int):
    total_amount = 0
    next_faul = faul(mass)

    while next_faul > 0:
        total_amount += next_faul
        next_faul = faul(next_faul)

    return total_amount


paer2 = sum(fuel_for_all_faul(mass) for mass in masses)
